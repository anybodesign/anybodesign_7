<?php if ( !defined('ABSPATH') ) die(); ?>
			...
			<div class="site-toolbar<?php if ( get_theme_mod('searchbar') ) { echo ' has-search'; } ?>">
				...
				<nav role="navigation" aria-label="<?php esc_attr_e('Toolbar Menu', 'anybodesign'); ?>">
			...
			<?php if ( get_theme_mod('searchbar') || get_theme_mod('contrast') ) { ?>
				...
				<form role="search" method="get" id="searchform" class="searchform" action="<?php echo home_url( '/' ); ?>">
				    <input type="search" value="<?php echo get_search_query(); ?>" name="s" id="s" placeholder="<?php esc_attr_e( 'Enter keyword', 'anybodesign' ); ?>">
				    <label for="s"><?php esc_html_e( 'Search for', 'anybodesign' ); ?></label>
					<input type="submit" class="action-btn" id="searchsubmit" value="<?php esc_attr_e( 'Search', 'anybodesign' ); ?>">
			    </form>
				<?php } ?>
				...
				<div class="contrast-switch">
					<button class="toggle-highcontrast" type="button">
						...
						<span><?php esc_html_e('High contrast', 'anybodesign'); ?></span>
					</button>
					<button class="toggle-remove" type="button">
						<img src="<?php echo FS_THEME_URL; ?>/img/ui/contrast-off.svg" alt="">
						<span><?php esc_html_e('Restore contrast', 'anybodesign'); ?></span>
					</button>
				</div>
				<?php } ?>
