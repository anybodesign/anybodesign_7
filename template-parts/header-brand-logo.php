...
?>
					...
					?>
					<img class="logo-mobile" src="<?php echo esc_url(get_theme_mod('site_logo_mobile', 'none')); ?>" alt=""<?php if ($logo_h2) { echo ' style="height:'.$height2.'rem"'; } ?>>
					<?php } ?>
					<?php if ( get_theme_mod('site_logo') ) { 
						$logo_h1 = get_theme_mod('site_logo_height');
						if ( $logo_h1 ) { $height1 = $logo_h1/10; };
					?>
					<img class="logo<?php if ( get_theme_mod('site_logo_mobile') ) { echo esc_attr(' has-mobile-logo'); } ?>" src="<?php echo esc_url(get_theme_mod('site_logo', 'none')); ?>" alt=""<?php if ($logo_h1) { echo ' style="height:'.$height1.'rem"'; } ?>>
					<?php } ?>					
